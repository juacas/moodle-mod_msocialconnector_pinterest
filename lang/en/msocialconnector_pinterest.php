...
$string['no_pinterest_name_advice2'] = '{$a->userfullname} is not linked to Pinterest. Register using Pinterest clicking in <a href="{$a->url}"><img src="{$a->pixurl}/loginwithPinterest.png" alt="Pinterest login"/></a>';
