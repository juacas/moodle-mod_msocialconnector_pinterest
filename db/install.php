...
/**
 * Post-install code for the msocialconnector_pinterest module.
 *
...
/**
 * Code run after the msocialconnector_pinterest module database tables have been created.
 * Migrate from old tables
 * @global moodle_database $DB
 * @return bool
 */
function xmldb_msocialconnector_pinterest_install() {
    global $CFG, $DB;
